...
module.exports = class extends Language {
  constructor (...args) {
    ...
    this.language = {
      ...
      COMMAND_SCRIMS_DESCRIPTION: 'Destiny Scrim games manager.',
      COMMAND_AVATAR_DESCRIPTION: 'Get a user\'s avatar.',
      COMMAND_STARBOARD_DESCRIPTION: 'Starboard for all your server needs.',
      COMMAND_STARBOARD_NOKEY: 'No option specified.',
      COMMAND_STARBOARD_NOKEYTWO: 'No value/secondary option specified.',
      COMMAND_STARBOARD_NOKEYTHREE: 'No value/third option specified.',
      COMMAND_STARBOARD_LIST_EMPTY: (type) => `The **${type}** is currently empty.`,
      COMMAND_STARBOARD_USER_NOTLISTED: (name, type) => `**${name}** is not on the **${type}**.`,
      COMMAND_STARBOARD_USER_LISTED: (name, type) => `**${name}** is already on the **${type}**.`,
      COMMAND_STARBOARD_CONFIG_NSFW: 'NSFW Channel?',
      COMMAND_STARBOARD_CONFIG_MINIMAL: 'Minimal?',
      COMMAND_STARBOARD_CONFIG_MINIMUM: 'Minimum',
      COMMAND_STARBOARD_CONFIG_EMOJI: 'Emoji',
      COMMAND_STARBOARD_CONFIG_CHANNEL: 'Channel',
      COMMAND_STARBOARD_CONFIG_SELFSTAR: 'Self Star?',
      COMMAND_STARBOARD_CONFIG_BOTSTARS: 'Remove Bot Stars?',
      COMMAND_STARBOARD_CONFIG_BLOCKMODE: 'Block mode',
      COMMAND_STARBOARD_CONFIG_NSFW_NOCHANNELSET: (key) => `The channel will be made **${key}** when it is set.`,
      COMMAND_STARBOARD_CONFIG_NOTTRUEFALSE: 'This option requires a `true` or `false` input.`',
      COMMAND_STARBOARD_CONFIG_NOTNUMERICAL: 'This option requires a numerical input.',
      COMMAND_STARBOARD_CONFIG_ISTRUE: 'This option is already `true`.',
      COMMAND_STARBOARD_CONFIG_ISFALSE: 'This option is already `false`.',
      COMMAND_STARBOARD_CONFIG_SETOPTION: (opt, key) => `The option **${opt}** has been set to **${key}**.`,
      COMMAND_STARBOARD_CONFIG_SETEMOJI: (key) => `The emoji for the server starboard has been set to ${key}`,
      COMMAND_STARBOARD_CONFIG_NOTGUILDEMOJI: 'That emoji is not from this guild.',
      COMMAND_STARBOARD_CONFIG_NOCHANNEL: 'This option requires a channel input.',
      COMMAND_STARBOARD_CONFIG_SETCHANNEL: (channel) => `The channel for the server starboard has been set to ${channel}`,
      COMMAND_STARBOARD_CONFIG_LISTMODE: 'The block mode can only either be `whitelist` or `blacklist`.',
      COMMAND_STARBOARD_CONFIG_LISTWL: 'The block mode is already a `whitelist`.',
      COMMAND_STARBOARD_CONFIG_LISTBL: 'The block mode is already a `blacklist`.',
      COMMAND_STARBOARD_CONFIG_RESETOPTION: (opt) => `The option **${opt}** has been reset to default.`,
      COMMAND_STARBOARD_CONFIG_LISTADD: (name, type) => `**${name}** has been added to the **${type}**.`,
      COMMAND_STARBOARD_CONFIG_LISTREMOVE: (name, type) => `**${name}** has been removed from the **${type}**.`,
      COMMAND_STARBOARD_CONFIG_NOUSER: 'No user specified.',
