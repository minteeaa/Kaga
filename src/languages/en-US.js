...
module.exports = class extends Language {
  constructor (...args) {
    ...
    this.language = {
      ...
      COMMAND_STARBOARD_CONF_NSFW: 'NSFW Channel?',
      COMMAND_STARBOARD_CONF_MINIMAL: 'Minimal?',
      COMMAND_STARBOARD_CONF_MINIMUM: 'Minimum',
      COMMAND_STARBOARD_CONF_EMOJI: 'Emoji',
      COMMAND_STARBOARD_CONF_CHANNEL: 'Channel',
      COMMAND_STARBOARD_CONF_SELFSTAR: 'Self Star?',
      COMMAND_STARBOARD_CONF_BOTSTARS: 'Remove Bot Stars?',
      COMMAND_STARBOARD_CONF_BLOCKMODE: 'Block mode',
      COMMAND_STARBOARD_CONF_NSFW_NOCHANNELSET: (key) => `The channel will be made **${key}** when it is set.`,
      COMMAND_STARBOARD_CONF_NOTTRUEFALSE: 'This option requires a `true` or `false` input.`',
      COMMAND_STARBOARD_CONF_NOTNUMERICAL: 'This option requires a numerical input.',
      COMMAND_STARBOARD_CONF_ISTRUE: 'This option is already `true`.',
      COMMAND_STARBOARD_CONF_ISFALSE: 'This option is already `false`.',
      COMMAND_STARBOARD_CONF_SETOPTION: (opt, key) => `The option **${opt}** has been set to **${key}**.`,
      COMMAND_STARBOARD_CONF_SETEMOJI: (key) => `The emoji for the server starboard has been set to ${key}`,
      COMMAND_STARBOARD_CONF_NOTGUILDEMOJI: 'That emoji is not from this guild.',
      COMMAND_STARBOARD_CONF_NOCHANNEL: 'This option requires a channel input.',
      COMMAND_STARBOARD_CONF_SETCHANNEL: (channel) => `The channel for the server starboard has been set to ${channel}`,
      COMMAND_STARBOARD_CONF_LISTMODE: 'The block mode can only either be `whitelist` or `blacklist`.',
      COMMAND_STARBOARD_CONF_LISTWL: 'The block mode is already a `whitelist`.',
      COMMAND_STARBOARD_CONF_LISTBL: 'The block mode is already a `blacklist`.',
      COMMAND_STARBOARD_CONF_RESETOPTION: (opt) => `The option **${opt}** has been reset to default.`,
      COMMAND_STARBOARD_CONF_LISTADD: (name, type) => `**${name}** has been added to the **${type}**.`,
      COMMAND_STARBOARD_CONF_LISTREMOVE: (name, type) => `**${name}** has been removed from the **${type}**.`,
      COMMAND_STARBOARD_CONF_NOUSER: 'No user specified.',
